...
case "$1" in
    "start")
        uwsgi --chdir=$ROOT --module=root.wsgi \
            ...
            --daemonize=$errlog
        chmod o+w $socket
        daphne -e ssl:443:privateKey=/home/ubuntu/webrtc/ssl/private.pem:certKey=/home/ubuntu/webrtc/ssl/cert.pem -b 0.0.0.0 -p 443 root.asgi:channel_layer -u /tmp/daphne.sock --access-log=/home/ubuntu/webrtc/djangoapps/logs/daphne.log &
