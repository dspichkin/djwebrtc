...
var ModeDialogMasterComponent = (function () {
    function ModeDialogMasterComponent(statusService, dialogsService, webSocketService, router) {
        ...
        this.status_voice_connection = 'starting'; //starting, run, stop
        var self = this;
    }
