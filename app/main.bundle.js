...
var MyDialogueEditViewComponent = (function () {
    ...
    MyDialogueEditViewComponent.prototype.savePersonages = function (item) {
        var _this = this;
        this.loading = true;
        var params = {
